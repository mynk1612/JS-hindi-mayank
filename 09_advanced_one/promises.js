//fetch('https://google.com').then().catch().finally()  // then = response, catch = error , finally = better 
const promiseOne = new Promise(function(resolve, reject){
    ...
    setTimeout(function(){
        ...
        resolve()  // method connect resolve to then
    }, 1000)
})  
...
const promiseThree = new Promise(function(resolve, reject){
    setTimeout(function() {
        resolve({username: "Mak", email: "mak@gmail.com"})
    }, 1000)
})
