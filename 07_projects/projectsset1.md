...
const guessSlot = document.querySelector('.quesses');
...
function validateGuess(guess){
  // validate on value lie b/w 1 to 100
  if(isNaN(guess)){
...
function displayGuess(guess){  
  // clean the values , update array and remaining  // cleaness
  userInput.value = ''
...
```
Javascript
const insert = documnet.getElementById('insert')
